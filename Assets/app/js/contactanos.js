...
function cargarDatosEdit(responseObj) {
    ...
    document.getElementById("asunto").value = responseObj.data.asunto;
    document.getElementById("mensaje").value = responseObj.data.mensaje;
...
function cargarDatos(responseObj) {
    ...
    document.getElementById("asunto_read").innerHTML = responseObj.data.asunto;
    document.getElementById("mensaje_read").innerHTML = responseObj.data.mensaje;
...
function setConfigTable(controlador, metodo) {
    ...
    configTable = {
        ...
        columnDefs: [
            ...
            { className: "text-start", targets: [3, 4, 5, 6, 7, 8, 9, 10, 11] },
            { className: "text-wrap min-wd-300 max-wd-300", targets: [8] },
            { className: "text-wrap min-wd-300 max-wd-300", targets: [12] }
        ],
        "columns": [
            { "data": "options" },
            { "data": "activo" },
