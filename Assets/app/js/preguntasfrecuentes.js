/*==================================================================
[ Variables ]*/
var controller = "PreguntasFrecuentes";
...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    if ($('#respuesta').length > 0) {
        ...
        $('#respuesta').summernote({
            ...
            placeholder: 'Ingrese Respuesta de la pregunta correspondiente',
            tabsize: 1,
            height: 150,
            toolbar: [
                ['style', ['style']],
...
function cargarDatosEdit(responseObj) {
    ...
    document.getElementById("pregunta").value = responseObj.data.pregunta;

    // summernote
    $("#respuesta").summernote("code", responseObj.data.respuesta);
    ...
    // var imagen = "Assets/files/preguntasfrecuentes/" + responseObj.data.image;
...
function cargarDatos(responseObj) {
    ...
    document.getElementById("pregunta_read").innerHTML = responseObj.data.pregunta;
    document.getElementById("respuesta_read").innerHTML = responseObj.data.respuesta;
...
function setConfigTable(controlador, metodo) {
    ...
    configTable = {
        ...
        columnDefs: [
            ...
            { className: "text-start text-wrap min-wd-260 max-wd-350", targets: [3] },
            { className: "text-start text-wrap min-wd-400 max-wd-500", targets: [4] }
        ],
        "columns": [
