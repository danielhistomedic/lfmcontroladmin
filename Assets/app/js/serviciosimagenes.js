/*==================================================================
[ Variables ]*/
var controller = "ServiciosImagenes";
...
function cargarDatosEdit(responseObj) {
    ...
    var imagen = "Assets/files/serviciosimagenes/" + responseObj.data.image;
...
function cargarDatos(responseObj) {
    ...
    document.getElementById("servicio_id_read").innerHTML = responseObj.data.servicio;
