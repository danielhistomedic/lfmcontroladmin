...
function cargarDatosEdit(responseObj) {
    ...
    // var div = document.getElementById('dropify_id');
    // while (div.firstChild) {
    //     div.removeChild(div.firstChild);
    // }

    document.getElementById('dropify_id').innerHTML = "";
    var imagen = "Assets/files/marcas/" + responseObj.data.image;
    ...
    // document.getElementById('adjunto').setAttribute('data-default-file', assets + "files/marcas/" + responseObj.data.image)
    $('.dropify').dropify({
        messages: {
