...
function cargarDatosEdit(responseObj) {
    ...
    // document.getElementById("archivo").value = responseObj.data.archivo;
    document.getElementById("menu").value = responseObj.data.menu;
    document.getElementById("submenu").value = responseObj.data.submenu;
...
function cargarDatos(responseObj) {
    ...
    document.getElementById("archivo_read").innerHTML = '<span><a style="text-decoration: underline;" href="' + assets + '/files/videos/' + responseObj.data.archivo + '" target="_blank">' + responseObj.data.archivo + '</a></span>';
    document.getElementById("menu_read").innerHTML = responseObj.data.menu;
    document.getElementById("submenu_read").innerHTML = responseObj.data.submenu;
...
function setConfigTable(controlador, metodo) {
    ...
    configTable = {
        ...
        'buttons': [{
                ...
                extend: 'excel',
                messageTop: "",
                title: 'Histoclin - Lista de Registros',
                exportOptions: {
                    columns: ':visible'
                }
            },
