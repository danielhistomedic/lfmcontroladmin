...
function cargarDatosEdit(responseObj) {
    ...
    document.getElementById("observaciones").value = responseObj.data.observaciones;
    ...
    // var imagen = "Assets/files/suscripciones/" + responseObj.data.image;
...
function cargarDatos(responseObj) {
    ...
    document.getElementById("observaciones_read").innerHTML = responseObj.data.observaciones;
