 ...
 */
class PreguntasFrecuentes extends Controllers
{

    private $session;
    private $permisosMod;

    const prefijo_msj_error = "faq";

    /**
     * Método Constructor de Controlador PreguntasFrecuentes.
    ...
    /**
     * Carga la Vista PreguntasFrecuentes. 
    ...
    public function PreguntasFrecuentes()
    {
        ...
        try {
            ...
            $this->permisosMod = $arrPermisos[MOD_CAT_PREGUNTAS_FRECUENTES];

            /*-------------------------------------------
            [ Obtener datos de Modulo ]*/
            $menus_model = new MenusModel;
            $menu = $menus_model->selectMenu(MOD_CAT_PREGUNTAS_FRECUENTES);
    ...
    public function getListaRecords()
    {
        ...
        try {
            ...
            $class_model = new PreguntasFrecuentesModel;
    ...
    public function setRecord()
    {
        ...
        try {
            ...
            $pregunta_lowercase = strtolower($pregunta);
            $slug = str_replace(" ", "_", $pregunta_lowercase);

            /*-------------------------------------------
            [ Valida formulario ]*/
            (trim($pregunta) == '') ? die(json_encode(getResponse("Debe indicar pregunta"), JSON_UNESCAPED_UNICODE)) : "";
            (trim($respuesta) == '') ? die(json_encode(getResponse("Debe indicar respuesta"), JSON_UNESCAPED_UNICODE)) : "";
            ...
            $class_model->setEmpresaId($empresa_id);
            $class_model->setSucursalId($sucursal_id);
            $class_model->setPregunta($pregunta);
            $class_model->setRespuesta($respuesta);
