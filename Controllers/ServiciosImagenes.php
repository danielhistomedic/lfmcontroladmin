...
/**
 * Controlador ServiciosImagenes 
 */
class ServiciosImagenes extends Controllers
{
    ...
    /**
     * Método Constructor de Controlador ServiciosImagenes.
    ...
    /**
     * Carga la Vista ServiciosImagenes. 
     ...
     */
    public function ServiciosImagenes()
    {
        ...
        try {
            ...
            $this->permisosMod = $arrPermisos[MOD_SERVICIOS_IMAGENES];

            /*-------------------------------------------
            [ Obtener datos de Modulo ]*/
            $menus_model = new MenusModel;
            $menu = $menus_model->selectMenu(MOD_SERVICIOS_IMAGENES);
            ...
            $data['menu'] = MOD_SERVICIOS_IMAGENES;
    ...
    public function getListaRecords()
    {
        ...
        try {
            ...
            $class_model = new ServiciosImagenesModel;
    ...
    public function getSelectRecords()
    {
        ...
        try {
            ...
            $rol_model = new ServiciosImagenesModel;
