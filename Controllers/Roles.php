...
class Roles extends Controllers
{
    ...
    public function Roles()
    {
        ...
        try {
            ...
            $menu = $menus_model->selectMenu(MOD_ROLES);
    ...
    public function getListaRecords()
    {
        ...
        try {
            ...
            for ($i = 0; $i < count($arrData); $i++) {
                ...
                if ($activo == 1) {
                    $btnPermisosModal = '<button type="button" class="mb-1 mt-1 me-1 btn btn-xs btn-outline-warning" data-animation="' . $data_animation . '" onclick="fntPermisosRol(this)" data-id="' . openssl_encrypt($arrData[$i]['id'], METHODENCRIPT, KEY) . '" data-modal="' . $arrData[$i]['id'] . '" title= "Asignar Permisos"><i class="fa-sharp fa-regular fa-key-skeleton "></i> </button>';
                }
                ...
                $arrData[$i]['options'] = '' . $btnView . ' ' . $btnPermisosModal .  ' ' . $btnEdit  . ' ' . $btnDelete . '';
    ...
    public function setRecord()
    {
        ...
        try {
            ...
            if ($record_id == 0) {
                ...
                $arrResponse['data'] = $arrData;
                $arrResponse['data']['id'] = openssl_encrypt($class_model->getId(), METHODENCRIPT, KEY);
            } else {
