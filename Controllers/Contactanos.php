...
class Contactanos extends Controllers
{
    ...
    const prefijo_msj_error = "contactanos";

    /**
     * Método Constructor de Controlador Contactanos.
    ...
    public function Contactanos()
    {
        ...
        try {
            ...
            $menu = $menus_model->selectMenu(MOD_CONTACTANOS);
    ...
    public function getListaRecords()
    {
        ...
        try {
            ...
            $class_model = new ContactanosModel;
