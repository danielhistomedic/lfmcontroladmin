...
/**
 * Controlador UnidadesMedida 
 */
class UnidadesMedida extends Controllers
{
    ...
    /**
     * Método Constructor de Controlador UnidadesMedida.
    ...
    public function UnidadesMedida()
    {
        ...
        try {
            ...
            $this->permisosMod = $arrPermisos[MOD_CAT_UNIDADES_MEDIDA];

            /*-------------------------------------------
            [ Obtener datos de Modulo ]*/
            $menus_model = new MenusModel;
            $menu = $menus_model->selectMenu(MOD_CAT_UNIDADES_MEDIDA);
            ...
            $data['menu'] = MOD_CAT_UNIDADES_MEDIDA;
    ...
    public function getListaRecords()
    {
        ...
        try {
            ...
            $class_model = new UnidadesMedidaModel;
    ...
    public function getSelectRecords()
    {
        ...
        try {
            ...
            $rol_model = new UnidadesMedidaModel;
