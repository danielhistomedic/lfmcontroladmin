...
class Banners extends Controllers
{
    ...
    /**
     * Método Constructor de Controlador Banners.
    ...
    public function Banners()
    {
        ...
        try {
            ...
            $this->permisosMod = $arrPermisos[MOD_CAT_BANNERS];

            /*-------------------------------------------
            [ Obtener datos de Modulo ]*/
            $menus_model = new MenusModel;
            $menu = $menus_model->selectMenu(MOD_CAT_BANNERS);
