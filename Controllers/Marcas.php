...
class Marcas extends Controllers
{
    ...
    /**
     * Método Constructor de Controlador Marcas.
    ...
    public function Marcas()
    {
        ...
        try {
            ...
            $this->permisosMod = $arrPermisos[MOD_CAT_MARCAS];

            /*-------------------------------------------
            [ Obtener datos de Modulo ]*/
            $menus_model = new MenusModel;
            $menu = $menus_model->selectMenu(MOD_CAT_MARCAS);
