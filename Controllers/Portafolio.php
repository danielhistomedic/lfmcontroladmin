...
class Portafolio extends Controllers
{
    ...
    /**
     * Método Constructor de Controlador Portafolio.
    ...
    public function Portafolio()
    {
        ...
        try {
            ...
            $this->permisosMod = $arrPermisos[MOD_PORTAFOLIO];

            /*-------------------------------------------
            [ Obtener datos de Modulo ]*/
            $menus_model = new MenusModel;
            $menu = $menus_model->selectMenu(MOD_PORTAFOLIO);
    ...
    public function getListaRecords()
    {
        ...
        try {
            ...
            $class_model = new PortafolioModel;
    ...
    public function setRecord()
    {
        ...
        try {
            ...
            if ($servicio_id == 0) {
                die(json_encode(getResponse("Debe indicar servicio direcciona"), JSON_UNESCAPED_UNICODE));
            }
