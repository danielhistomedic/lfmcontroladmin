...
/**
 * Controlador LineasProducto 
 */
class LineasProducto extends Controllers
{
    ...
    /**
     * Método Constructor de Controlador LineasProducto.
    ...
    public function LineasProducto()
    {
        ...
        try {
            ...
            $this->permisosMod = $arrPermisos[MOD_CAT_LINEAS_PRODUCTO];

            /*-------------------------------------------
            [ Obtener datos de Modulo ]*/
            $menus_model = new MenusModel;
            $menu = $menus_model->selectMenu(MOD_CAT_LINEAS_PRODUCTO);
            ...
            $data['menu'] = MOD_CAT_LINEAS_PRODUCTO;
    ...
    public function getListaRecords()
    {
        ...
        try {
            ...
            $class_model = new LineasProductoModel;
    ...
    public function getSelectRecords()
    {
        ...
        try {
            ...
            $rol_model = new LineasProductoModel;
