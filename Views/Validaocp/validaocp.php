        ...
        <div class="validation-card">
            ...
            <div class="card-body-custom">
                ...
                <?php if (!empty($pedido)): ?>
                    ...
                    <?php if (!empty($data['sello_digital'])): ?>
                    <!-- Sección Sello Digital de Autenticidad -->
                    <div class="section-title mt-4">
                        <i class="bx bx-certification text-primary"></i> Sello Digital de Autenticidad
                    </div>

                    <?php if (!empty($data['cadena_original'])): ?>
                    <div class="info-box mb-3" style="background: #F8FAFC; border-left: 4px solid var(--lfm-primary);">
                        <div class="info-label mb-1"><i class="bx bx-code-alt me-1 text-primary"></i> Cadena Original Generada</div>
                        <div class="info-value font-monospace user-select-all" style="font-size: 0.75rem; word-break: break-all; color: #475569; letter-spacing: 0.5px; line-height: 1.4;">
                            <?= htmlspecialchars($data['cadena_original']); ?>
                        </div>
                    </div>
                    <?php endif; ?>

                    <div class="info-box mb-2" style="background: #F1F5F9; border-left: 4px solid var(--lfm-red);">
                        <div class="info-label mb-1"><i class="bx bx-key me-1 text-danger"></i> Firma / Hash de Verificación Digital (SHA-256)</div>
                        <div class="info-value font-monospace user-select-all" style="font-size: 0.75rem; word-break: break-all; color: #334155; letter-spacing: 0.5px; line-height: 1.4;">
                            <?= htmlspecialchars($data['sello_digital']); ?>
                        </div>
                    </div>
                    <?php endif; ?>
