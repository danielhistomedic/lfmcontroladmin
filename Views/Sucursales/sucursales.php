                                ...
                                <form class="theme-form needs-validation position-relative" id="formRegistration" novalidate="">
                                    ...
                                    <div class="row m-t-10">
                                        ...
                                        <div class="form-group  col-12 col-sm-6 col-xl-4">
                                            ...
                                            <input class="form-control btn-square" id="nombre" type="text" name="nombre" placeholder="Ingrese Nombre" autocomplete="off" required="">
                                            <div class="invalid-feedback">Valor requerido.</div>
                                        </div>

                                        <div class="form-group  col-12 col-sm-6 col-xl-4">
                                            <label class="form-label" for="email">Email:</label>
                                            <input class="form-control btn-square" id="email" type="text" name="email" placeholder="Ingrese Email" autocomplete="off" required="">
                                            <div class="invalid-feedback">Valor requerido.</div>
                                        </div>
                                        ...
                                        <div class="form-group  col-12 col-sm-6 col-xl-4">
                                            ...
                                            <input class="form-control btn-square" id="telefono" type="text" name="telefono" placeholder="Ingrese Telefono" autocomplete="off" required="">
                                            <div class="invalid-feedback">Valor requerido.</div>
                                        </div>
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-12 col-sm-6 col-lg-3 col-xxl-2">
                                                    <label class="form-label fs-13">Nombre: </label>
                                                    <h5 class="vistadatos fs-14 text-muted" id="nombre_read"><i class="fa-light fa-brake-warning"></i> No Registrado</h5>
                                                </div>

                                                <div class="form-group col-12 col-sm-6 col-lg-3 col-xxl-2">
                                                    <label class="form-label fs-13">Email: </label>
                                                    <h5 class="vistadatos fs-14 text-muted" id="email_read"><i class="fa-light fa-brake-warning"></i> No Registrado</h5>
                                                </div>

                                                <div class="form-group col-12 col-sm-6 col-lg-3 col-xxl-2">
                                                    <label class="form-label fs-13">Telefono: </label>
                                                    <h5 class="vistadatos fs-14 text-muted" id="telefono_read"><i class="fa-light fa-brake-warning"></i> No Registrado</h5>
                                                </div>
