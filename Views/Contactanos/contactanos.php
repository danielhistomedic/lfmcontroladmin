                                    ...
                                    <table id="tableRecords" class="table table-bordered text-nowrap table-striped table-hover key-buttons border-bottom w-100">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0 fw-semibold text-center">Empresa</th>
                                                ...
                                                <th class="border-bottom-0 fw-semibold text-center">Asunto</th>
                                                <th class="border-bottom-0 fw-semibold text-center">Mensaje</th>
                        ...
                        <form class="theme-form needs-validation position-relative" id="formRecords" novalidate="">
                            ...
                            <div class="row m-t-10">
                                ...
                                <div class="form-group col-12 col-sm-6 col-xl-8">
                                    ...
                                    <input class="form-control btn-square" id="asunto" name="asunto" type="text" disabled="disabled" placeholder="Ingrese asunto">
                                    <div class="invalid-feedback">Valor requerido.</div>
                                </div>

                                <div class="form-group col-12 ">
                                    <label class="control-label" for="mensaje">Mensaje:</label>
                                    <textarea class="form-control" id="mensaje" name="mensaje" disabled="disabled"></textarea>
                                    <div class="invalid-feedback">Valor requerido.</div>
                                </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12 col-sm-6 col-lg-3 col-xxl-3 ">
                                        ...
                                        <p class="mt-0 text-secondary" id="asunto_read"><i class="fa-light fa-brake-warning"></i> No Registrado</p>
                                    </div>

                                    <div class="form-group col-12 col-sm-6 col-lg-3 col-xxl-3 ">
                                        <label class="control-label ">Mensaje: </label>
                                        <p class="mt-0 text-secondary" id="mensaje_read"><i class="fa-light fa-brake-warning"></i> No Registrado</p>
                                    </div>
