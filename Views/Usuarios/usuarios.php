            ...
            <section class="card card-featured shadow-sm mb-4">
                ...
                <div class="card-body loading-panel-showing">
                    ...
                    <div class="btn-group flex-wrap" role="group" aria-label="Basic example">
                        <button style="" class="btn btn-outline-primary  <?= $disabled = ($data['permisosMod']['c']) ? '' : 'disabled'; ?>" type="button" id="btnCreate" data-animation="fadeInDown" title="Nuevo Registro"><i class="fa-regular fa-user-plus fa-lg"></i> Nuevo</button>
                                    ...
                                    <table id="tableRecords" class="table table-bordered text-nowrap table-striped table-hover key-buttons border-bottom w-100">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0 fw-semibold text-center">Usuario</th>
                                                ...
                                                <th class="border-bottom-0 fw-semibold text-center">Rol</th>
                        ...
                        <form class="theme-form needs-validation position-relative" id="formRecords" novalidate="">
                            ...
                            <div class="row m-t-10">
                                ...
                                <div class="form-group  col-12 col-sm-6 col-xl-4">
                                    ...
                                    <input class="form-control btn-square" id="usuario" type="email" name="usuario" placeholder="Ingrese Usuario" required="">
                                ...
                                <!-- <div class="form-group col-12 col-sm-6 col-xl-4">
                                    ...
                                    <div class="">
                                        <select data-plugin-selectTwo class="form-control populate select2 custom-select" id="comboSucursal" name="sucursal_id" style="width: 100%" data-plugin-options='{ "language": "es", "placeholder": "Seleccione una opción", "minimumResultsForSearch": "Infinity" }' required="">
                                        </select>
                                        <div class="invalid-feedback">Valor requerido.</div>
                                    </div>
                                </div> -->
                                ...
                                <div class="form-group  col-12 col-sm-6 col-xl-4">
                                    ...
                                    <input class="form-control btn-square" id="nombre" name="nombre" type="text" placeholder="Ingrese Nombre" required="">
                                    <div class="invalid-feedback">Valor requerido.</div>
                                </div>

                                <div class="form-group  col-12 col-sm-6 col-xl-4">
                                    <label class="control-label" for="paterno">Apellido Paterno:</label>
                                    <input class="form-control btn-square" id="paterno" name="paterno" type="text" placeholder="Ingrese Apellido Paterno" required="">
                                    <div class="invalid-feedback">Valor requerido.</div>
                                </div>

                                <div class="form-group col-12 col-sm-6 col-xl-4">
                                    <label class="control-label" for="materno">Apellido Materno:</label>
                                    <input class="form-control btn-square" id="materno" name="materno" type="text" placeholder="Ingrese Apellido Materno" required="">
                                    <div class="invalid-feedback">Valor requerido.</div>
                                </div>

                                <div class="form-group  col-12 col-sm-6 col-xl-4">
                                    <label class="control-label" for="telefono">Telefono:</label>
                                    <input class="form-control btn-square" id="telefono" name="telefono" type="number" placeholder="Ingrese Nombre" required="">
                                    <div class="invalid-feedback">Valor requerido.</div>
                                </div>

                                <div class="form-group  col-12 col-sm-6 col-xl-4">
                                    <label class="control-label" for="email">Email:</label>
                                    <input class="form-control btn-square" id="email" type="email" name="email" placeholder="Ingrese Email" required="">
                                    <div class="invalid-feedback">Ingrese un email correcto.</div>
                                </div>

                                <!-- <div class="form-group col-12 col-sm-6 col-xl-4">
                                    <label class="control-label" for="comboSexo">Sexo:</label>
                                    <div class="">
                                        <select data-plugin-selectTwo class="form-control populate select2 custom-select" id="comboSexo" name="sexo" style="width: 100%" data-plugin-options='{ "language": "es", "placeholder": "Seleccione una opción", "minimumResultsForSearch": "Infinity" }' required="">
                                ...
                                <div class="form-group col-12 col-sm-6 col-xl-4">
                                    <label class="control-label" for="comboRoles">Rol de Acceso:</label>
                                    <div class="">
                                        <select data-plugin-selectTwo class="form-control populate select2 custom-select" id="comboRoles" name="rol" style="width: 100%" data-plugin-options='{ "language": "es", "placeholder": "Seleccione una opción", "minimumResultsForSearch": "Infinity" }' required="">
                                        </select>
                                        <div class="invalid-feedback">Valor requerido.</div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-12 col-sm-6 col-xl-4 position-relative">
                                    ...
                                    <input class="form-control btn-square" id="password" name="password" type="password" placeholder="Password">
                                    <div class="invalid-feedback">Valor requerido.</div>
                                ...
                                <div class="form-group col-12 col-sm-6 col-xl-4 position-relative">
                                    ...
                                    <input class="form-control btn-square" id="password_confirm" name="password_confirm" type="password" placeholder="Password">
                                    <div class="invalid-feedback">Valor requerido.</div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="form-group col-12 col-sm-6 col-lg-4 col-xxl-3">
                                        ...
                                        <p class="mt-0 text-secondary" id="sexo_read"><i class="fa-light fa-brake-warning"></i> No Registrado</p>
                                    </div> -->
                                    ...
                                    <div class="form-group col-12 col-sm-6 col-lg-4 col-xxl-3">
                                        ...
                                        <p class="mt-0 text-secondary" id="rol_read"><i class="fa-light fa-brake-warning"></i> No Registrado</p>
                                    </div>
                                    ...
                                    <div class="collapse row" id="collapseMostrarMasMenos">
                                        ...
                                        <div class="form-group col-12 col-sm-6 col-lg-3 col-xxl-2 pt-3">
