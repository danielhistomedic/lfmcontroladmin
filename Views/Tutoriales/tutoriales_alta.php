                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12 mt-4">
                                        <div class="border-bottom subtitulos_panel">
                                            <p class="mb-0 fw-600 text-info"><i class="fa-regular fa-bars-staggered text-info text-info-shadow fs-18"></i> Lista de Registros.</p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive export-table">
                                            <table id="tableRecords" class="table table-bordered text-nowrap table-striped table-hover key-buttons border-bottom w-100">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="border-bottom-0 fw-semibold text-center">Titulo</th>
                                                        <th class="border-bottom-0 fw-semibold text-center">Menu</th>
                                                        <th class="border-bottom-0 fw-semibold text-center">Submenu</th>
                                                        <th class="border-bottom-0 fw-semibold text-center">Descripción</th>
                            ...
                            <div class="" id="create_edit" style="display: none;">
                                ...
                                <form class="theme-form needs-validation position-relative" id="formRegistration" novalidate="">
                                    ...
                                    <div class="row m-t-10">
                                        ...
                                        <div class="form-group col-12 mt-4">
                                            <div class="border-bottom subtitulos_panel">
                                                <p class="mb-0 fw-600 text-info"><i class="fa-regular fa-pencil text-info text-info-shadow fs-18"></i> Datos a Registrar/Editar.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group  col-12 col-sm-6">
                                            ...
                                            <input class="form-control btn-square" id="titulo" type="text" name="titulo" placeholder="Ingrese Título" required="">
                                            <div class="invalid-feedback">Valor requerido.</div>
                                        </div>

                                        <div class="form-group  col-12 col-sm-6">
                                            <label class="form-label" for="adjunto_file">Archivo:</label>
                                            ...
                                            <!-- <input class="form-control btn-square" id="archivo" type="text" name="archivo" placeholder="Ingrese Archivo" required=""> -->
                                            <div class="invalid-feedback">Valor requerido.</div>
                                        </div>

                                        <div class="form-group  col-12 col-sm-6">
                                            <label class="form-label" for="menu">Menu:</label>
                                            <input class="form-control btn-square" id="menu" type="text" name="menu" placeholder="Ingrese Menu" required="">
                                            <div class="invalid-feedback">Valor requerido.</div>
                                        </div>

                                        <div class="form-group  col-12 col-sm-6">
                                            <label class="form-label" for="submenu">Submenu:</label>
                                            <input class="form-control btn-square" id="submenu" type="text" name="submenu" placeholder="Ingrese Submenu" required="">
                                            <div class="invalid-feedback">Valor requerido.</div>
                                        </div>

                                        <div class="form-group  col-12">
                                            <label class="form-label" for="descripcion">Descripcion:</label>
                                            <input class="form-control btn-square" id="descripcion" type="text" name="descripcion" placeholder="Ingrese Descripcion" required="">
                                            <div class="invalid-feedback">Valor requerido.</div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group mt-4">
                                            <div class="border-bottom subtitulos_panel">
                                                <p class="mb-0 fw-600 text-info"><i class="fa-regular fa-file-lines text-info text-info-shadow fs-18"></i> Datos de Registro Seleccionado.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-12 col-sm-6 col-lg-3 col-xxl-2">
                                                    <label class="form-label fs-13">Título: </label>
                                                    <h5 class="vistadatos fs-14 text-muted" id="titulo_read"><i class="fa-light fa-brake-warning"></i> No Registrado</h5>
                                                </div>

                                                <div class="form-group col-12 col-sm-6 col-lg-3 col-xxl-2">
                                                    <label class="form-label fs-13">Archivo: </label>
                                                    <h5 class="vistadatos fs-14 text-muted" id="archivo_read"><i class="fa-light fa-brake-warning"></i> No Registrado</h5>
                                                </div>

                                                <div class="form-group col-12 col-sm-6 col-lg-3 col-xxl-2">
                                                    <label class="form-label fs-13">Menu: </label>
                                                    <h5 class="vistadatos fs-14 text-muted" id="menu_read"><i class="fa-light fa-brake-warning"></i> No Registrado</h5>
                                                </div>

                                                <div class="form-group col-12 col-sm-6 col-lg-3 col-xxl-2">
                                                    <label class="form-label fs-13">Submenu: </label>
                                                    <h5 class="vistadatos fs-14 text-muted" id="submenu_read"><i class="fa-light fa-brake-warning"></i> No Registrado</h5>
                                                </div>

                                                <div class="form-group col-12 col-sm-6 col-lg-3 col-xxl-2">
                                                    <label class="form-label fs-13">Descripcion: </label>
                                                    <h5 class="vistadatos fs-14 text-muted" id="descripcion_read"><i class="fa-light fa-brake-warning"></i> No Registrado</h5>
                                                </div>
