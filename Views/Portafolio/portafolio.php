                                    ...
                                    <table id="tableRecords" class="table table-bordered text-nowrap table-striped table-hover key-buttons border-bottom w-100">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0 fw-semibold text-center">Servicio Direcciona</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
                        ...
                        <form class="theme-form needs-validation position-relative" id="formRecords" novalidate="">
                            ...
                            <div class="row m-t-10">
                                ...
                                <div class="form-group mb-3 col-12 col-sm-6 col-xl-4">
                                    ...
                                    <input class="form-control btn-square" id="name" name="name" type="text" placeholder="Ingrese Titulo" required="">
                                ...
                                <div class="form-group col-12 col-sm-6 col-xl-4">
                                    <label class="control-label" for="comboServicios">Servicio Direcciona:</label>
                                    <div class="">
                                        <select data-plugin-selectTwo class="form-control populate select2 custom-select" id="comboServicios" name="servicio_id" style="width: 100%" data-plugin-options='{ "language": "es", "placeholder": "Seleccione una opción", "minimumResultsForSearch": "Infinity" }' required="">
                                        </select>
                                        <div class="invalid-feedback">Valor requerido.</div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-4 col-sm-12 mb-4 mb-lg-0">
                                    <label class="control-label" for="adjunto">Imagen:</label>
                                    <div id="dropify_id">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12 col-sm-6 col-lg-4 col-xxl-3 ">
                                        <label class="control-label ">Servicio Direcciona: </label>
                                        <p class="mt-0 text-secondary" id="servicio_id_read"><i class="fa-light fa-brake-warning"></i> No Registrado</p>
                                    </div>
