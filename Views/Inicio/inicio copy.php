                        ...
                        <header class="card-header bg-primary w-100">
                            ...
                            <div class="widget-profile-info">
                                ...
                                <div class="profile-info">
                                    <h4 class="name font-weight-semibold">Victor Daniel Perez</h4>
                            ...
                            <ol class="tm-items">
                                <li>
                                    <div class="tm-box">
                                        ...
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas hendrerit augue at leo viverra, aliquam egestas lectus laoreet. Donec vehicula vestibulum ipsum, tincidunt ultrices elit suscipit ac. Sed eget risus laoreet, varius nibh id, luctus ligula.
                                            Nulla facilisi. <span class="text-primary">#awesome</span>
                                        </p>
                                    </div>
                                </li>
                                <li>
                                    <div class="tm-box">
                                        ...
                                        <div class="thumbnail-gallery">
                                            <a class="img-thumbnail lightbox" href="<?= assets(); ?>/img/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
