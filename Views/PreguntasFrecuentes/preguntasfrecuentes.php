                                    ...
                                    <table id="tableRecords" class="table table-bordered text-nowrap table-striped table-hover key-buttons border-bottom w-100">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0 fw-semibold text-center">Pregunta</th>
                                                <th class="border-bottom-0 fw-semibold text-center">Respuesta</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
                        ...
                        <form class="theme-form needs-validation position-relative" id="formRecords" novalidate="">
                            ...
                            <div class="row m-t-10">
                                ...
                                <div class="form-group mb-3 col-12">
                                    ...
                                    <input class="form-control btn-square" id="pregunta" name="pregunta" type="text" placeholder="Ingrese Pregunta" required="">
                                ...
                                <!-- <div class="form-group col-lg-4 col-sm-12 mb-4 mb-lg-0">
                                    ...
                                    <div id="dropify_id">
                                        <input type="file" class="dropify" id="adjunto" name="adjunto" data-default-file="" data-bs-height="180" data-allowed-file-extensions="png jpg" data-max-file-size-preview="1M" required />
                                    </div>
                                </div> -->
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12 col-sm-6 col-lg-4 col-xxl-3  pt-3">
                                        ...
                                        <p class="mt-0 text-secondary" id="pregunta_read"><i class="fa-light fa-brake-warning"></i> No Registrado</p>
                                    </div>

                                    <div class="form-group col-12 col-sm-6 col-lg-4 col-xxl-3 ">
                                        <label class="control-label ">Respuesta: </label>
                                        <p class="mt-0 text-secondary" id="respuesta_read"><i class="fa-light fa-brake-warning"></i> No Registrado</p>
                                    </div>
