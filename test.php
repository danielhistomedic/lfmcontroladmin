...
<body>
    <section class="body">
        ...
        <header class="header header-nav-menu header-nav-links">
            <div class="logo-container">
                <a href="../" class="logo">
                    ...
                    <img src="<?= assets(); ?>/img/logo-modern.png" class="logo-image" width="90" height="24" alt="Porto Admin" /><img src="<?= assets(); ?>/img/logo-default.png" class="logo-image-mobile" width="90" height="41" alt="Porto Admin" />
                </a>
        ...
        <div class="inner-wrapper">
            ...
            <section role="main" class="content-body content-body-modern mt-0 fondo-general">
    ...
    <script src="<?= assets(); ?>/js/examples/examples.ecommerce.form.js"></script>
