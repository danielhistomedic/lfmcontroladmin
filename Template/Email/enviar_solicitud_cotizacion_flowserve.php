        ...
        <tr>
            <td align="center" style="padding:30px 15px;">
                ...
                <table width="80%" cellpadding="0" cellspacing="0" border="0"
                    style="min-width:600px;background:#ffffff;border-radius:10px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:30px 35px 10px 35px;color:#3b3b3b;">
                            ...
                            <p style="margin-top:0;">
                                ...
                                <span style=" font-weight:bold;">FLOWSERVE S. DE R.L. DE C.V. (MEXICO)</span><br>
                                <span style=" font-weight:bold;">ING. SHARON URBINA</span><br>
                                <span style=" font-weight:bold;">COMMERCIAL OPERATIONS - FCO</span>
                            </p>

                            <p>
                                Solicitamos de su valioso apoyo para cotizar los siguientes productos/servicios, agradeciendo nos comparta su propuesta técnica y económica considerando las especificaciones indicadas.
                            </p>
                            <!-- <p>
                        ...
                        <td style="padding:0 35px 25px 35px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="15%" style="padding-right:10px;">
                                        <table width="100%" bgcolor="#f7f9fc"
                                            style="border-left:4px solid #19a974;">
                                            <tr>
                                                <td style="padding:15px;">
                                                    <div style="font-size:11px;color:#777;">
                                                        FOLIO SOCLICITUD
                                    ...
                                    <td width="20%" style="padding-right:10px;">
                                        <table width="100%" bgcolor="#f7f9fc"
                                            style="border-left:4px solid #d0454c ;">
                                            <tr>
                                                <td style="padding:15px;">
                                                    <div style="font-size:11px;color: #d0454c;font-weight:600;">
                                                        <span>SOLICITUD DE REGISTRO DE OPORTUNIDAD</span>
                                                    </div>
                                                    <div style="font-size:12px;font-weight:600;text-transform: uppercase;">
                                                        Ingeniero Leonardo, ¿nos podría compartir un no. de oportunidad, por favor?
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td width="50%">
                                        <table width="100%" bgcolor="#f7f9fc"
                                            style="border-left:4px solid #f0ab00;">
                                            <tr>
                                                <td style="padding:15px;">
                                                    <div style="font-size:11px;color:#777;">
                                                        USUARIO FINAL:
                                                    ...
                                                    <div style="font-size:12px;font-weight:600;text-transform: uppercase;">
                                                        INSTRUMENTACION Y AUTOMATIZACION<br> INSTRUMENTACION Y AUTOMATIZACION INDUSTRIAL DE MEXICO <br> AV FERROCARRIL HIDALGO 106 INT 5 COL. VILLAS DE PACHUCA, PACHUAC DE SOTOS, HIDALGO C.P. 42083
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table width="100%" bgcolor="#f7f9fc"
                                            ...
                                            <tr>
                                                <td style="padding:15px;">
                                                    ...
                                                    <div style="font-size:15px;font-weight:600;">
                                                        CLIENTE FINAL : CFE, Veracruz Atraves de un contratista llamado Grupo Intera
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <tr>
                        <td style="padding:0 35px 20px 35px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                style="border:1px solid #dfe3e8;border-collapse:collapse;margin-top:15px;">
                                ...
                                <!-- 3DPU031632 Válvula de bola 1” 1500# bridada McCanna 1”-SA53-6L-G-S6 (3 piezas)
Kit de asientos McCanna 236080901 para válvula de 10” Incluye 2 piezas (2 piezas)
3DPU036203 Válvula de bola 2-S301-6L-J-6L (2 piezas)
3DPU131812 Válvula de bola 2”-Z151-S6-U-S6 (3 piezas)
3DPU036119 Válvula de bola 6”-S151-S6-J-S6 (1 pieza) -->

                                <tr style="background-color:#FFFFFF;">
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">PVD-2026-00039</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">3</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">pieza</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:left;">3DPU031632 Válvula de bola 1” 1500# bridada McCanna 1”-SA53-6L-G-S6</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:left;white-space: pre-line;">SERVICIO DE FABRICACION D EBASTIDO CRANE DEMING MODELO 3065 TAMAÑAO A 70 13

                                        OFRECEMOS
                                        BASTIODOR (SOPORTE) PARA BOMBA CRANE DEMING MODELO
                                        3065 TAMAÑO A 70 ITEM 19 DEL EXPLOSIVO ANEXO
                                    </td>
                                </tr>
                                <tr style="background-color:#F8FAFC;">
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">PVD-2026-00039</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">2</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">pieza</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:left;">Kit de asientos McCanna 236080901 para válvula de 10” Incluye 2 piezas</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:left;white-space: pre-line;">SERVICIO DE FABRICACION D EBASTIDO CRANE DEMING MODELO 3065 TAMAÑAO A 70 13
                                ...
                                <tr style="background-color:#FFFFFF;">
                                    ...
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">2</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">pieza</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:left;">3DPU036203 Válvula de bola 2-S301-6L-J-6L</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:left;white-space: pre-line;">SERVICIO DE FABRICACION D EBASTIDO CRANE DEMING MODELO 3065 TAMAÑAO A 70 13
                                ...
                                <tr style="background-color:#F8FAFC;">
                                    ...
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">3</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">pieza</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:left;">3DPU131812 Válvula de bola 2”-Z151-S6-U-S6</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:left;white-space: pre-line;">SERVICIO DE FABRICACION D EBASTIDO CRANE DEMING MODELO 3065 TAMAÑAO A 70 13
                                ...
                                <tr style="background-color:#FFFFFF;">
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">PVD-2026-00039</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">1</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:center;">pieza</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:left;">3DPU036119 Válvula de bola 6”-S151-S6-J-S6</td>
                                    <td style="padding:10px;border:1px solid #E5E5E5;text-align:left;white-space: pre-line;">SERVICIO DE FABRICACION D EBASTIDO CRANE DEMING MODELO 3065 TAMAÑAO A 70 13
                                ...
                                <tr>
                                    <td style="padding:20px;">
                                        ...
                                        <ul style="margin:0;padding-left:20px;color:#555;">
                                            <li>Referencia del Folio de la Cotización.</li>
                                            <li>Precio unitario y total referenciando el codigo de partida</li>
                                            <li>Tiempo estimado de entrega.</li>
                                            <li>Condiciones de pago.</li>
                                            <li>Vigencia de la cotización.</li>
                                            <li>Terminos de Pago.</li>
