...
/**
 * Clase PortafolioModel
 */
class PortafolioModel extends Mysql
{
    ...
    /**
     * Método Constructor de PortafolioModel.
    ...
    public function selectRecords(): array
    {
        ...
        try {
            ...
            [ Instruccion sql ]*/
            $sql = "SELECT ";
            $sql .= "t.*, us.usuario, s.name as servicio_direcciona ";
            $sql .= "FROM " . PortafolioModel::CONSTANTES_MODEL['tabla'] . " t ";
    ...
    public function selectRecord(int $record_id): array
    {
        ...
        try {
            ...
            [ Instruccion sql ]*/
            $sql = "SELECT ";
            $sql .= "t.*, CONCAT_WS(' ', dat_gen.nombre, dat_gen.paterno, dat_gen.materno)  as usuario, s.name as servicio_direcciona ";
            $sql .= "FROM " . PortafolioModel::CONSTANTES_MODEL['tabla'] . " t ";
    ...
    public function validInsertExist(string $texto_valida): bool
    {
        ...
        try {
            ...
            /*-------------------------------------------
            [ Instruccion sql ]*/
            $sql = "SELECT id FROM " . PortafolioModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
    ...
    public function validUpdateExistRecord(string $texto_valida, int $id): bool
    {
        ...
        try {
            ...
            [ Instruccion sql ]*/
            $sql = "";
            $sql .= "SELECT * FROM " . PortafolioModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
     ...
     * 
     * @param model &$model
     * Envío del modelo \PortafolioModel por referencia, para asiganr el valor lastInsertId al modelo.
     *
     * @return bool $response
     ...
     * 
     */
    public function insertRecord(PortafolioModel &$modelo): bool
    {
     ...
     * 
     * @param object PortafolioModel $model
     * Envío del modelo por referencia con los datos requeridos para el insert
     *
     */
    public function recordCreate(PortafolioModel &$modelo): int
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "INSERT INTO " . PortafolioModel::CONSTANTES_MODEL['tabla'] . " SET ";
     ...
     * 
     */
    private function insertAdjunto(PortafolioModel $modelo): bool
    {
        ...
        try {
            ...
            $ruta_doctos = "Assets/files/portafolio/";
     ...
     * 
     */
    public function updateRecord(PortafolioModel $modelo): bool
    {
     ...
     *
     */
    public function recordUpdate(PortafolioModel &$modelo): bool
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "UPDATE " . PortafolioModel::CONSTANTES_MODEL['tabla'] . " SET ";
        $sql .= "empresa_id = :empresa_id, ";
        $sql .= "sucursal_id = :sucursal_id, ";
        $sql .= "name = :name, ";
        $sql .= "descripcion = :descripcion, ";
     ...
     * 
     */
    public function updateEstatusRecord(PortafolioModel $model): bool
    {
