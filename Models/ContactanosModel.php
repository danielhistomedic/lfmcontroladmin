...
class ContactanosModel extends Mysql
{
    ...
    const TABLA = "contactanos";
    const PREFIJO_TABLA = "ssf_";

    /**
     * Método Constructor de ContactanosModel.
     ...
     * 
     */
    public function selectRecords(ContactanosModel $modelo, bool $ordenarAlfabeticamente = false): array
    {
     ...
     * 
     */
    public function selectRecord(ContactanosModel $modelo): array
    {
     ...
     * 
     */
    public function validUpdateExistRecord(ContactanosModel $modelo): bool
    {
     ...
     * 
     */
    public function updateRecord(ContactanosModel $modelo): bool
    {
     ...
     */
    private function recordUpdate(ContactanosModel &$modelo): bool
    {
     ...
     * 
     */
    public function updateEstatusRecord(ContactanosModel $model): bool
    {
