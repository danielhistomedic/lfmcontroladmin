...
/**
 * Clase ListaPreciosModel
 */
class ListaPreciosModel extends Mysql
{
    ...
    /**
     * Método Constructor de ListaPreciosModel.
    ...
    public function selectRecords(): array
    {
        ...
        try {
            ...
            $sql = "SELECT ";
            $sql .= "t.*, us.usuario ";
            $sql .= "FROM " . ListaPreciosModel::CONSTANTES_MODEL['tabla'] . " t ";
    ...
    public function validInsertExist(string $texto_valida): bool
    {
        ...
        try {
            ...
            /*-------------------------------------------
            [ Instruccion sql ]*/
            $sql = "SELECT id FROM " . ListaPreciosModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
    ...
    public function validUpdateExistRecord(string $texto_valida, int $id): bool
    {
        ...
        try {
            ...
            [ Instruccion sql ]*/
            $sql = "";
            $sql .= "SELECT * FROM " . ListaPreciosModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
     ...
     * 
     * @param model &$model
     * Envío del modelo \ListaPreciosModel por referencia, para asiganr el valor lastInsertId al modelo.
     *
     * @return bool $response
     ...
     * 
     */
    public function insertRecord(ListaPreciosModel &$modelo): bool
    {
     ...
     * 
     * @param object ListaPreciosModel $model
     * Envío del modelo por referencia con los datos requeridos para el insert
     *
     */
    public function recordCreate(ListaPreciosModel &$modelo): int
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "INSERT INTO " . ListaPreciosModel::CONSTANTES_MODEL['tabla'] . " SET ";
     ...
     * 
     * @param object $ListaPreciosModel 
     ...
     * 
     */
    private function insertAdjunto(ListaPreciosModel $modelo): bool
    {
        ...
        try {
            ...
            $ruta_doctos = "Assets/files/listaprecios/";
     ...
     * 
     */
    public function updateRecord(ListaPreciosModel $modelo): bool
    {
     ...
     *
     */
    public function recordUpdate(ListaPreciosModel &$modelo): bool
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "UPDATE " . ListaPreciosModel::CONSTANTES_MODEL['tabla'] . " SET ";
        $sql .= "empresa_id = :empresa_id, ";
        $sql .= "sucursal_id = :sucursal_id, ";
        $sql .= "name = :name, ";
        $sql .= "descripcion = :descripcion, ";
     ...
     * 
     */
    public function updateEstatusRecord(ListaPreciosModel $model): bool
    {
