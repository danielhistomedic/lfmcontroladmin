 ...
 * Clase LegalesModel
 */
class LegalesModel extends Mysql
{
    private $id;
    private $empresa_id;
    private $sucursal_id;
    ...
    /**
     * Método Constructor de LegalesModel.
     ...
     * 
     */
    public function selectRecord(LegalesModel $modelo): array
    {
     ...
     * 
     */
    public function updateRecord(LegalesModel $modelo): bool
    {
     ...
     */
    private function recordUpdate(LegalesModel &$modelo): bool
    {
        ...
        try {
            ...
            $arrData = [
                'id' => $modelo->getId(),
                'empresa_id' => $modelo->getEmpresaId(),
                'terminos' => $modelo->getTerminos(),
                'aviso' => $modelo->getAviso(),
                'envio' => $modelo->getEnvio(),
    ...
    /**
     * Set the value of terminos
     */
    public function setTerminos($terminos): self
    {
    ...
    /**
     * Set the value of aviso
     */
    public function setAviso($aviso): self
    {
        $this->aviso = $aviso;
