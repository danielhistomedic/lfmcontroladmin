...
class ServiciosModel extends Mysql
{
    ...
    /**
     * Método Constructor de ServiciosModel.
    ...
    public function selectRecords(): array
    {
        ...
        try {
            ...
            $sql = "SELECT ";
            $sql .= "t.*, us.usuario ";
            $sql .= "FROM " . ServiciosModel::CONSTANTES_MODEL['tabla'] . " t ";
    ...
    public function validInsertExist(string $texto_valida): bool
    {
        ...
        try {
            ...
            /*-------------------------------------------
            [ Instruccion sql ]*/
            $sql = "SELECT id FROM " . ServiciosModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
    ...
    public function validUpdateExistRecord(string $texto_valida, int $id): bool
    {
        ...
        try {
            ...
            [ Instruccion sql ]*/
            $sql = "";
            $sql .= "SELECT * FROM " . ServiciosModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
     ...
     * 
     * @param model &$model
     * Envío del modelo \ServiciosModel por referencia, para asiganr el valor lastInsertId al modelo.
     *
     * @return bool $response
     ...
     * 
     */
    public function insertRecord(ServiciosModel &$modelo): bool
    {
     ...
     * 
     * @param object ServiciosModel $model
     * Envío del modelo por referencia con los datos requeridos para el insert
     *
     */
    public function recordCreate(ServiciosModel &$modelo): int
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "INSERT INTO " . ServiciosModel::CONSTANTES_MODEL['tabla'] . " SET ";
     ...
     * 
     */
    private function insertAdjunto(ServiciosModel $modelo): bool
    {
        ...
        try {
            ...
            $ruta_doctos = "Assets/files/servicios/";
     ...
     * 
     */
    public function updateRecord(ServiciosModel $modelo): bool
    {
     ...
     *
     */
    public function recordUpdate(ServiciosModel &$modelo): bool
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "UPDATE " . ServiciosModel::CONSTANTES_MODEL['tabla'] . " SET ";
        $sql .= "empresa_id = :empresa_id, ";
        $sql .= "sucursal_id = :sucursal_id, ";
        $sql .= "name = :name, ";
        $sql .= "descripcion = :descripcion, ";
     ...
     * 
     */
    public function updateEstatusRecord(ServiciosModel $model): bool
    {
