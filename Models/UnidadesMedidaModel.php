...
/**
 * Clase UnidadesMedidaModel
 */
class UnidadesMedidaModel extends Mysql
{
    ...
    /**
     * Método Constructor de UnidadesMedidaModel.
    ...
    public function selectRecords(): array
    {
        ...
        try {
            ...
            $sql = "SELECT ";
            $sql .= "t.*, us.usuario ";
            $sql .= "FROM " . UnidadesMedidaModel::CONSTANTES_MODEL['tabla'] . " t ";
    ...
    public function validInsertExist(string $texto_valida): bool
    {
        ...
        try {
            ...
            /*-------------------------------------------
            [ Instruccion sql ]*/
            $sql = "SELECT id FROM " . UnidadesMedidaModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
    ...
    public function validUpdateExistRecord(string $texto_valida, int $id): bool
    {
        ...
        try {
            ...
            [ Instruccion sql ]*/
            $sql = "";
            $sql .= "SELECT * FROM " . UnidadesMedidaModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
     ...
     * 
     * @param model &$model
     * Envío del modelo \UnidadesMedidaModel por referencia, para asiganr el valor lastInsertId al modelo.
     *
     * @return bool $response
     ...
     * 
     */
    public function insertRecord(UnidadesMedidaModel &$modelo): bool
    {
     ...
     * 
     * @param object UnidadesMedidaModel $model
     * Envío del modelo por referencia con los datos requeridos para el insert
     *
     */
    public function recordCreate(UnidadesMedidaModel &$modelo): int
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "INSERT INTO " . UnidadesMedidaModel::CONSTANTES_MODEL['tabla'] . " SET ";
     ...
     * 
     * @param object $UnidadesMedidaModel 
     ...
     * 
     */
    private function insertAdjunto(UnidadesMedidaModel $modelo): bool
    {
        ...
        try {
            ...
            $ruta_doctos = "Assets/files/unidadesmedida/";
     ...
     * 
     */
    public function updateRecord(UnidadesMedidaModel $modelo): bool
    {
     ...
     *
     */
    public function recordUpdate(UnidadesMedidaModel &$modelo): bool
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "UPDATE " . UnidadesMedidaModel::CONSTANTES_MODEL['tabla'] . " SET ";
        $sql .= "empresa_id = :empresa_id, ";
        $sql .= "sucursal_id = :sucursal_id, ";
        $sql .= "name = :name, ";
        $sql .= "descripcion = :descripcion, ";
     ...
     * 
     */
    public function updateEstatusRecord(UnidadesMedidaModel $model): bool
    {
