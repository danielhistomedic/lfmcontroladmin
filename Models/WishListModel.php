 ...
 * Clase WishListModel
 */
class WishListModel extends Mysql
{
    ...
    /**
     * Método Constructor de WishListModel.
    ...
    public function selectRecords(): array
    {
        ...
        try {
            ...
            $sql = "SELECT ";
            $sql .= "t.*, us.usuario ";
            $sql .= "FROM " . WishListModel::CONSTANTES_MODEL['tabla'] . " t ";
    ...
    public function validInsertExist(string $texto_valida): bool
    {
        ...
        try {
            ...
            /*-------------------------------------------
            [ Instruccion sql ]*/
            $sql = "SELECT id FROM " . WishListModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
    ...
    public function validUpdateExistRecord(string $texto_valida, int $id): bool
    {
        ...
        try {
            ...
            [ Instruccion sql ]*/
            $sql = "";
            $sql .= "SELECT * FROM " . WishListModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
     ...
     * 
     * @param model &$model
     * Envío del modelo \WishListModel por referencia, para asiganr el valor lastInsertId al modelo.
     *
     * @return bool $response
     ...
     * 
     */
    public function insertRecord(WishListModel &$modelo): bool
    {
     ...
     * 
     * @param object WishListModel $model
     * Envío del modelo por referencia con los datos requeridos para el insert
     *
     */
    public function recordCreate(WishListModel &$modelo): int
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "INSERT INTO " . WishListModel::CONSTANTES_MODEL['tabla'] . " SET ";
     ...
     * 
     */
    private function insertAdjunto(WishListModel $modelo): bool
    {
        ...
        try {
            ...
            $ruta_doctos = "Assets/files/wishlist/";
     ...
     * 
     */
    public function updateRecord(WishListModel $modelo): bool
    {
     ...
     *
     */
    public function recordUpdate(WishListModel &$modelo): bool
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "UPDATE " . WishListModel::CONSTANTES_MODEL['tabla'] . " SET ";
        $sql .= "empresa_id = :empresa_id, ";
        $sql .= "sucursal_id = :sucursal_id, ";
        $sql .= "name = :name, ";
        $sql .= "descripcion = :descripcion, ";
     ...
     * 
     */
    public function updateEstatusRecord(WishListModel $model): bool
    {
