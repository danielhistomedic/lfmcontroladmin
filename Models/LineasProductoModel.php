...
/**
 * Clase LineasProductoModel
 */
class LineasProductoModel extends Mysql
{
    ...
    const CONSTANTES_MODEL = array(
        "tabla" => "lineasproducto"
    );


    /**
     * Método Constructor de LineasProductoModel.
    ...
    public function selectRecords(): array
    {
        ...
        try {
            ...
            $sql = "SELECT ";
            $sql .= "t.*, us.usuario ";
            $sql .= "FROM " . LineasProductoModel::CONSTANTES_MODEL['tabla'] . " t ";
    ...
    public function validInsertExist(string $texto_valida): bool
    {
        ...
        try {
            ...
            /*-------------------------------------------
            [ Instruccion sql ]*/
            $sql = "SELECT id FROM " . LineasProductoModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
    ...
    public function validUpdateExistRecord(string $texto_valida, int $id): bool
    {
        ...
        try {
            ...
            [ Instruccion sql ]*/
            $sql = "";
            $sql .= "SELECT * FROM " . LineasProductoModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
     ...
     * 
     * @param model &$model
     * Envío del modelo \LineasProductoModel por referencia, para asiganr el valor lastInsertId al modelo.
     *
     * @return bool $response
     ...
     * 
     */
    public function insertRecord(LineasProductoModel &$modelo): bool
    {
     ...
     * 
     * @param object LineasProductoModel $model
     * Envío del modelo por referencia con los datos requeridos para el insert
     *
     */
    public function recordCreate(LineasProductoModel &$modelo): int
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "INSERT INTO " . LineasProductoModel::CONSTANTES_MODEL['tabla'] . " SET ";
     ...
     * 
     * @param object $LineasProductoModel 
     ...
     * 
     */
    private function insertAdjunto(LineasProductoModel $modelo): bool
    {
        ...
        try {
            ...
            $ruta_doctos = "Assets/files/lineasproducto/";
     ...
     * 
     */
    public function updateRecord(LineasProductoModel $modelo): bool
    {
     ...
     *
     */
    public function recordUpdate(LineasProductoModel &$modelo): bool
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "UPDATE " . LineasProductoModel::CONSTANTES_MODEL['tabla'] . " SET ";
        $sql .= "empresa_id = :empresa_id, ";
        $sql .= "sucursal_id = :sucursal_id, ";
        $sql .= "name = :name, ";
        $sql .= "descripcion = :descripcion, ";
     ...
     * 
     */
    public function updateEstatusRecord(LineasProductoModel $model): bool
    {
