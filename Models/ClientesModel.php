...
class ClientesModel extends Mysql
{
    ...
    /**
     * Método Constructor de ClientesModel.
    ...
    public function selectRecords(): array
    {
        ...
        try {
            ...
            $sql = "SELECT ";
            $sql .= "t.*, us.usuario ";
            $sql .= "FROM " . ClientesModel::CONSTANTES_MODEL['tabla'] . " t ";
    ...
    public function validInsertExist(string $texto_valida): bool
    {
        ...
        try {
            ...
            /*-------------------------------------------
            [ Instruccion sql ]*/
            $sql = "SELECT id FROM " . ClientesModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
    ...
    public function validUpdateExistRecord(string $texto_valida, int $id): bool
    {
        ...
        try {
            ...
            [ Instruccion sql ]*/
            $sql = "";
            $sql .= "SELECT * FROM " . ClientesModel::CONSTANTES_MODEL['tabla'] . " ";
            $sql .= "WHERE ";
     ...
     * 
     * @param model &$model
     * Envío del modelo \ClientesModel por referencia, para asiganr el valor lastInsertId al modelo.
     *
     * @return bool $response
     ...
     * 
     */
    public function insertRecord(ClientesModel &$modelo): bool
    {
     ...
     * 
     * @param object ClientesModel $model
     * Envío del modelo por referencia con los datos requeridos para el insert
     *
     */
    public function recordCreate(ClientesModel &$modelo): int
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "INSERT INTO " . ClientesModel::CONSTANTES_MODEL['tabla'] . " SET ";
     ...
     * 
     */
    private function insertAdjunto(ClientesModel $modelo): bool
    {
        ...
        try {
            ...
            $ruta_doctos = "Assets/files/clientes/";
     ...
     * 
     */
    public function updateRecord(ClientesModel $modelo): bool
    {
     ...
     *
     */
    public function recordUpdate(ClientesModel &$modelo): bool
    {
        ...
        /*-------------------------------------------
            [ Instruccion sql ]*/
        $sql = "UPDATE " . ClientesModel::CONSTANTES_MODEL['tabla'] . " SET ";
        $sql .= "empresa_id = :empresa_id, ";
        $sql .= "sucursal_id = :sucursal_id, ";
        $sql .= "name = :name, ";
        $sql .= "descripcion = :descripcion, ";
     ...
     * 
     */
    public function updateEstatusRecord(ClientesModel $model): bool
    {
